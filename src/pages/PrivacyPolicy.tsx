          ...
          <div className="relative px-4 sm:px-6 lg:px-8">
            <div className="prose prose-indigo max-w-none text-gray-500">
              ...
              <ul>
                ...
                <li>
                  <p><strong>Organization</strong> (referred to as either "the Organization", "We", "Us" or "Our" in this Agreement) refers to Anenitigray Development Services, Mekelle, Tigray.</p>
                </li>
                <li>
                ...
                <li>
                  <p><strong>Website</strong> refers to ADS Website, accessible from <a href="http://www.anenitigray.org" rel="external nofollow noopener" target="_blank">http://www.anenitigray.org</a></p>
                </li>
                <li>
