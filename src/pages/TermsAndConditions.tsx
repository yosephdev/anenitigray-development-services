...
const TermsAndConditions: React.FC = () => {
  const { t } = useLanguage(); // In case you want to translate the title or other static parts later
          ...
          <div className="relative px-4 sm:px-6 lg:px-8">
            <div className="prose prose-indigo max-w-none text-gray-500">
              ...
              <ul>
                ...
                <li>
                  <p><strong>Organization</strong> (referred to as either &quot;the Organization&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Anenitigray Development Services (ADS), Mekelle, Tigray.</p>
                </li>
                <li>
                ...
                <li>
                  <p><strong>Terms and Conditions</strong> (also referred as &quot;Terms&quot;) mean these Terms and Conditions that form the entire agreement between You and the Organization regarding the use of the Service. This Terms and Conditions agreement has been created with the help of the <a href="https://www.termsfeed.com/terms-conditions-generator/" target="_blank" rel="noopener noreferrer">Terms and Conditions Generator</a>.</p>
                </li>
                <li>
                  <p><strong>Third-party Social Media Service</strong> means any services or content (including data, information, products or services) provided by a third-party that may be displayed, included or made available by the Service.</p>
                </li>
                <li>
                  <p><strong>Website</strong> refers to ADS Website, accessible from <a href="https://www.anenitigray.org" rel="external nofollow noopener" target="_blank">https://www.anenitigray.org</a></p>
                </li>
                <li>
              ...
              <p>You represent that you are over the age of 18. The Organization does not permit those under 18 to use the Service.</p>
              ...
              <p>Our Service may contain links to third-party web sites or services that are not owned or controlled by the Organization.</p>
              <p>The Organization has no control over, and assumes no responsibility for, the content, privacy policies, or practices of any third party web sites or services. You further acknowledge and agree that the Organization shall not be responsible or liable, directly or indirectly, for any damage or loss caused or alleged to be caused by or in connection with the use of or reliance on any such content, goods or services available on or through any such web sites or services.</p>
              <p>We strongly advise You to read the terms and conditions and privacy policies of any third-party web sites or services that You visit.</p>
              <h2>Termination</h2>
              <p>We may terminate or suspend Your access immediately, without prior notice or liability, for any reason whatsoever, including without limitation if You breach these Terms and Conditions.</p>
              <p>Upon termination, Your right to use the Service will cease immediately.</p>
              <h2>Limitation of Liability</h2>
              <p>Notwithstanding any damages that You might incur, the entire liability of the Organization and any of its suppliers under any provision of this Terms and Your exclusive remedy for all of the foregoing shall be limited to the amount actually paid by You through the Service or 100 USD if You haven't purchased anything through the Service.</p>
              ...
              <ul>
                <li>By email: contact@anenitigray.org</li>
              </ul>
            </div>
          </div>
        </div>
