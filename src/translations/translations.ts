...
export const translations: Record<Language, Record<string, string>> = {
    en: {
        ...
        'about.mission.paragraph1': "Our mission is to create sustainable development opportunities for 50,000 vulnerable communities in Tigray by 2025. We are dedicated to fostering development through community-driven initiatives, focusing on empowering local populations. In 2025, our key program areas included Integrated Child Care Support, the ASSET project for teacher support and training, Rapid Relief operations, and Capacity Building for volunteers to enhance psychosocial support and child-friendly spaces.",
    ...
    ti: {
        ...
        // Impact Snippets (Homepage/About)
        'impact.stat.lives': 'ዝተደገፉ ህይወት (2025)',
        'impact.stat.lives.number': '3,132',
        ...
        // Programs Page / Sections
        'programs.title': 'መደባትናን ንጥፈታትናን (2025 ትኹረት)',
